<div class="min-h-screen bg-black text-white flex items-center justify-center lg:justify-between px-6 py-12 md:px-16 lg:px-24 xl:px-32 max-w-[1600px] mx-auto gap-12">
    ...
    <div class="hidden lg:flex flex-col text-left space-y-8 max-w-xl w-1/2">
        ...
        <div class="flex items-center gap-3.5">
            ...
            <span class="text-4xl font-black tracking-tighter text-red-600">KZSTRM</span>
        </div>
    ...
    <div class="w-full lg:w-[560px] flex justify-center lg:justify-end">
        <div class="w-full max-w-[520px] bg-zinc-900 border border-zinc-800 rounded-[20px] p-8 md:p-10 shadow-2xl">
            ...
            <div class="mb-8">
                ...
                <p class="text-sm text-zinc-400 mt-2">Your watchlist missed you. Pick up where you left off.</p>
            </div>
            ...
            <form wire:submit.prevent="authenticate" class="space-y-6">
                ...
                <div>
                    <label for="login" class="block text-[11px] font-bold text-zinc-400 tracking-wider uppercase mb-2">
                        EMAIL OR USERNAME
                    </label>
                    <input 
                        type="text" 
                ...
                <div x-data="{ show: false }">
                    <div class="flex items-center justify-between mb-2">
                        ...
                        @if (filament()->hasPasswordReset())
                            <a href="{{ $this->getForgotPasswordUrl() }}" class="text-[11px] text-zinc-500 hover:text-zinc-300 transition duration-150 font-medium">
                                Forgot password?
                            </a>
                        @endif
                    </div>
                ...
                >
                    ...
                    <span wire:loading wire:target="authenticate" class="inline-flex items-center justify-center">
            ...
            <div class="mt-8 pt-6 border-t border-zinc-800 text-center">
                <p class="text-sm text-zinc-400">
                    New to KZSTRM? <a href="{{ filament()->getRegistrationUrl() }}" class="text-red-500 hover:text-red-400 font-medium transition duration-150">Create account</a>
                </p>
            </div>
        </div>
    </div>
